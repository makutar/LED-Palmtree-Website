          ...
          <div class="flat-panel">
            <div class="panel-body project-panel">
              ...
              <div class="col-sm-8 .row-eq-height">
                ...
                <hr class="margin-10">  
                <h3 class="zero-text-margin grey-text">Sep 2015 - Ongoing</h3>
                <p>Codebreaker is a phone application which deciphers and solves codeword puzzles by taking a photo. A prototype was created at a 24 hour hackathon, <a href='http://unihack.net/archive/2015/'>UniHack 2015</a>, in Kivy and we are now working on producing a full native Android app.</p>
              </div>  
            </div>
            <div class="play-div">
